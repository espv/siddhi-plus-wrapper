...
public class FireRuleMultipleQueries {
    ...
    public static void main(String[] args) {
        ...
        String siddhiApp = "" +
                ...
                "" +
                "@info(name = 'query1') " +
                "from every (h = humidityStream [percentage < 25] -> t = temperatureStream [value > 45] -> h2 = humidityStream [percentage < 25]) within 500 seconds " +
